      ...
      <div class="flex flex-col lg:flex-row gap-12 lg:gap-20">
        <div class="lg:w-1/3">
          <contentBox padding="p-8" :custom-class="'text-center'">
            ...
            <p class="text-cyan-400 font-mono mt-2">[Your Role]</p>
            <div class="flex justify-center gap-4 mt-6">
              <a href="#" class="p-3 rounded-lg border border-gray-700 text-gray-400 hover:border-cyan-500 hover:text-cyan-400 transition-colors">
              ...
              <a href="#" class="p-3 rounded-lg border border-gray-700 text-gray-400 hover:border-purple-500 hover:text-purple-400 transition-colors">
